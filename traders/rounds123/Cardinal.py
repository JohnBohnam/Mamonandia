...
class Trader:
	...
	def order_gift_basket(self, state):
		...
		res_buy = mid_price['GIFT_BASKET'] - mid_price['ROSES'] - mid_price['CHOCOLATE'] * 4  - mid_price['STRAWBERRIES'] * 6 - 390
		res_sell = mid_price['GIFT_BASKET'] - mid_price['ROSES'] - mid_price['CHOCOLATE'] * 4  - mid_price['STRAWBERRIES'] * 6 - 390
